...
def build_condition_prompt(condition_encoder, condition_maps, dropout_probability=0.0):
    return condition_encoder(condition_maps, dropout_probability=dropout_probability)

def build_blank_prompt(condition_encoder):
    return condition_encoder.null_image_tokens
...
def validate_dual_vae_para(
    ...
    blank_prompt = build_blank_prompt(condition_encoder)
                ...
                if global_step % args.env.checkpointing_steps == 0:
                    save_training_checkpoint(
                        ...
                        extra_state={
                            ...
                            "condition_text_token_count": 0,
                            "condition_prompt_token_count": (
                                condition_encoder.token_grid_size ** 2
                            ),
